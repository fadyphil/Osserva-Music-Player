    ...
    group('deleteSong', () {
      ...
      test('should use MediaStore on Android', () async {
        ...
        if (Platform.isAndroid) {
          when(() => mockMediaStore.deleteFileUsingUri(uriString: any(named: 'uriString')))
          ...
          // ASSERT
          expect(result, true);
          verify(() => mockMediaStore.deleteFileUsingUri(uriString: 'content://media/external/audio/media/$tId'))
              .called(1);
        }
      });
