...
import 'package:music_player/core/router/guards/onboarding_guard.dart';
...
void main() {
  ...
  setUp(() {
    ...
    serviceLocator.registerSingleton<CheckIfUserIsFirstTimer>(mockCheckIfUserIsFirstTimer);
  ...
  test('should redirect to OnboardingRoute if user is first timer', () async {
    // ARRANGE
    when(() => mockCheckIfUserIsFirstTimer(any()))
    ...
    verify(() => mockRouter.replace(any(that: isA<OnboardingRoute>()))).called(1);
  });
