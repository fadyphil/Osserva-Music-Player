...
mixin _$MusicPlayerState {
 ...
 QueueStatus get queueActionStatus; String get errorMessage; Map<int, int> get playCounts; String get currentGenre;// Sleep Timer
 Duration? get timerRemaining; bool get isEndTrackTimerActive;
...
@useResult
$Res call({
 bool isPlaying, Duration position, Duration duration, SongEntity? currentSong, List<SongEntity> queue, int currentIndex, bool isShuffling, int loopMode, bool isPlaylistEnd, bool isLoading, bool isPlayerReady, bool isSeeking, bool isPlayingFromQueue, bool isPlayingFromPlaylist, QueueStatus queueActionStatus, String errorMessage, Map<int, int> playCounts, String currentGenre, Duration? timerRemaining, bool isEndTrackTimerActive
});
...
as String,timerRemaining: freezed == timerRemaining ? _self.timerRemaining : timerRemaining // ignore: cast_nullable_to_non_nullable
as Duration?,isEndTrackTimerActive: null == isEndTrackTimerActive ? _self.isEndTrackTimerActive : isEndTrackTimerActive // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of MusicPlayerState
...
// Sleep Timer
@override final  Duration? timerRemaining;
@override@JsonKey() final  bool isEndTrackTimerActive;
...
@override
int get hashCode => Object.hashAll([runtimeType,isPlaying,position,duration,currentSong,const DeepCollectionEquality().hash(_queue),currentIndex,isShuffling,loopMode,isPlaylistEnd,isLoading,isPlayerReady,isSeeking,isPlayingFromQueue,isPlayingFromPlaylist,queueActionStatus,errorMessage,const DeepCollectionEquality().hash(_playCounts),currentGenre,timerRemaining,isEndTrackTimerActive]);
