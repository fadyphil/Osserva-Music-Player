...
import 'package:music_player/features/analytics/presentation/widgets/new_widgets/heatmap.dart';
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // 2. Activity — time-of-day distribution (from AnalyticsBloc)
              AnalyticsCard(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    const SizedBox(height: 16),
                    // 3 log-based widgets — driven by HistoryBloc
                    BlocBuilder<HistoryBloc, HistoryState>(
                      builder: (context, historyState) {
                        final logs = historyState.maybeMap(
              ...
              // 4. Genre Density
              GenreDensityCard(topGenres: data.topGenres),
